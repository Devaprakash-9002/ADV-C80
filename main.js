...
function sorting() {
    ...
    var remove_commas_sorting=display_student_array_sorting.join(" ");
    console.log(remove_commas_sorting);
    document.getElementById("display_name_without_commas").innerHTML=remove_commas_sorting;
}}